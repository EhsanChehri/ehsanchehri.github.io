...
برای حل تمرینات decoy در صورت نداشتن اکانت چس دات کام پیشنهاد میکنم از برنامه کم حجم chess king در اندروید استفاده کنید که میتونید از [اینجا](https://www.farsroid.com/chess-king-android/) دانلودش کنید
